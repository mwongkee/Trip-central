...
export function seedItems(): Item[] {
  return [
    ...
    place('item-ferry', 'Alderney Ferry → Halifax', 'activity', 44.6647, -63.56544, 'Catch the ferry from Alderney Landing across the harbour — a quick, cheap ride with great skyline views (runs every ~15–30 min). Pays your transit fare.', {
    ...
    place('item-boardwalk', 'Halifax Waterfront Boardwalk', 'outdoor', 44.6472, -63.56994, 'Right off the Halifax ferry terminal — a 4.4 km harbourfront boardwalk with food, buskers, the blue wave sculpture, and the orange hammocks.', {
    ...
    place('item-drift', 'Drift', 'restaurant', 44.646, -63.56954, 'Seafood + cocktails in the Queen’s Marque district on the boardwalk.', { address: '1709 Lower Water St, Halifax', tags: ['walkable', 'tonight'] }),
    ...
    place('item-gahan', 'Gahan House Harbour', 'restaurant', 44.647, -63.57186, 'Waterfront brewpub — burgers, fish & chips, house beer; kid-friendly.', { address: 'Cable Wharf, Halifax', tags: ['walkable', 'tonight'] }),
    ...
    place('item-edna', 'EDNA', 'restaurant', 44.6555, -63.58954, 'Buzzy North-End bistro; brunch favourite.', { address: '2053 Gottingen St, Halifax' }),
    place('item-kingofdonair', 'King of Donair', 'restaurant', 44.6479, -63.59759, 'The original Halifax donair (since 1973).', { address: '6420 Quinpool Rd, Halifax' }),
    ...
    place('item-woodenmonkeydart', 'The Wooden Monkey (Dartmouth)', 'restaurant', 44.6647, -63.56736, 'Top floor of the Alderney ferry terminal — pizzas, pasta, kids’ menu, harbour views. Grab dinner before/after the ferry.', { address: '40 Alderney Dr, Dartmouth', tags: ['walkable', 'tonight'], website: 'https://www.thewoodenmonkey.ca/' }),
    ...
    place('item-johnslunch', "John's Lunch", 'restaurant', 44.6525, -63.5638, 'Woodside landmark (since 1969) famous for fish & chips.', { address: '352 Pleasant St, Dartmouth' }),
    ...
    place('item-townclock', 'Halifax Town Clock', 'landmark', 44.6478, -63.57756, 'The iconic clock on the slope below the Citadel.', { address: 'Brunswick St, Halifax', tags: ['walkable'] }),
    ...
    place('item-morriseast', 'Morris East', 'restaurant', 44.644, -63.57696, 'Wood-fired pizza and cocktails downtown.', { address: '5212 Morris St, Halifax', tags: ['walkable'] }),
    ...
    place('item-oaklawnzoo', 'Oaklawn Farm Zoo', 'other', 45.001, -64.743, 'Family zoo with lions, tigers and many animals, Aylesford (~1.5 h).', { address: 'Aylesford, NS', tags: ['kids', 'daytrip'], website: 'https://oaklawnfarmzoo.ca' }),
    ...
    place('item-rossfarm', 'Ross Farm Museum', 'museum', 44.7375, -64.453, 'Living 19th-century heritage farm with hands-on activities, New Ross (~1 h).', { address: 'New Ross, NS', tags: ['kids', 'daytrip'], website: 'https://rossfarm.novascotia.ca' }),
    ...
    place('item-cheesecurds', 'Cheese Curds Gourmet Burgers', 'restaurant', 44.677, -63.52304, 'Gourmet burgers and poutine; kid-friendly, several HRM locations.', { address: 'Dartmouth', tags: ['kids'], website: 'https://cheesecurdsburgers.com' }),
    ...
    place('item-amano', 'Ristorante a Mano', 'restaurant', 44.6452, -63.56924, 'Bishop’s Landing Italian on the boardwalk — pasta + wood-fired pizza.', { address: '1477 Lower Water St, Halifax', tags: ['walkable', 'tonight'] }),
    place('item-damaurizio', 'Da Maurizio', 'restaurant', 44.6447, -63.57496, 'Upscale Italian in the historic Brewery Market.', { address: '1496 Lower Water St, Halifax', tags: ['walkable'] }),
    ...
    place('item-athens', 'The Athens', 'restaurant', 44.647, -63.59754, 'Family Greek restaurant on Quinpool Rd.', { address: '6273 Quinpool Rd, Halifax', tags: ['kids'] }),
    place('item-agricola', 'Agricola Street Brasserie', 'restaurant', 44.6575, -63.59204, 'North-End brasserie — brunch and bistro fare.', { address: '2540 Agricola St, Halifax' }),
    place('item-salvatores', "Salvatore's Pizzaiolo", 'restaurant', 44.661, -63.60196, 'Authentic thin-crust pizza in the Hydrostone.', { address: '5541 Young St, Halifax', tags: ['kids'] }),
    ...
    place('item-goodrobot', 'Good Robot Brewing', 'restaurant', 44.6555, -63.59146, 'Quirky North-End brewery with a garden patio, brunch and bar bites.', { address: '2736 Robie St, Halifax', tags: ['kids'], website: 'https://goodrobotbrewing.ca' }),
    place('item-2crows', '2 Crows Brewing', 'restaurant', 44.647, -63.57441, 'Downtown craft brewery known for hazy and mixed-fermentation beers.', { address: '1932 Brunswick St, Halifax', tags: ['walkable'], website: 'https://2crowsbrewing.com' }),
    ...
    place('item-busstop', 'Bus Stop Theatre', 'activity', 44.6555, -63.58904, 'Intimate North-End indie theatre and performance space.', { address: '2203 Gottingen St, Halifax' }),
    ...
    place('item-puttingedge', 'Putting Edge', 'activity', 44.677, -63.52496, 'Glow-in-the-dark indoor mini-golf plus an arcade, Dartmouth Crossing.', { address: 'Dartmouth Crossing', tags: ['rainy-day', 'kids'], website: 'https://puttingedge.com' }),
    ...
    place('item-brewerymarket', 'Halifax Brewery Farmers’ Market', 'shopping', 44.6447, -63.57304, 'Saturday market in the historic Keith’s brewery building — food, makers and music.', { address: '1496 Lower Water St, Halifax', tags: ['walkable'], website: 'https://halifaxbrewerymarket.com' }),
    ...
    place('item-flynns', "Flynn's Dairy Bar & Convenience", 'restaurant', 44.6562, -63.5888, 'Tons of flavours of milkshakes, sundaes and scoops, North End Halifax.', { address: 'North End, Halifax', tags: ['kids'] }),

    // ---- Halifax Waterfront tours & rentals ----
    place('item-ambassatours', 'Ambassatours Tall Ship Silva', 'activity', 44.647, -63.56994, 'Harbour sailing tours aboard the tall ship Silva from the boardwalk.', { address: 'Halifax Waterfront', tags: ['walkable', 'tonight', 'kids'], website: 'https://ambassatours.com' }),
    ...
    place('item-jfarwell', 'J. Farwell Sailing Tours', 'activity', 44.647, -63.57151, 'Small-group harbour sailing adventures from the boardwalk.', { address: 'Halifax Waterfront', tags: ['walkable', 'tonight'] }),
    ...
    // ---- Pools & splash pads ----
    place('item-canadagames', 'Canada Games Centre', 'activity', 44.653, -63.64404, 'Big indoor aquatic + fitness centre with a leisure pool and slides, Clayton Park.', { address: '26 Thomas Raddall Dr, Halifax', tags: ['kids', 'rainy-day'], website: 'https://canadagamescentre.ca' }),
    ...
    place('item-studioeast', 'Studio East Food + Drink', 'restaurant', 44.6461, -63.59827, 'Inventive pan-Asian small plates on Quinpool — a local favourite.', { address: '6021 Cunard St, Halifax', tags: ['kids'] }),
    ...
    place('item-ostrichclub', 'Ostrich Club', 'restaurant', 44.6555, -63.59096, 'Acclaimed wood-fired North-End restaurant and natural-wine bar.', { address: '2454 Agricola St, Halifax' }),
    place('item-lionbright', 'Lion & Bright', 'restaurant', 44.6575, -63.59396, 'Café by day, wine bar by night on Agricola St.', { address: '2534 Agricola St, Halifax', tags: ['kids'] }),
    ...
    place('item-mappatura', 'Mappatura Bistro', 'restaurant', 44.6478, -63.57446, 'Fresh handmade pasta and Italian plates downtown.', { address: '5883 Spring Garden Rd, Halifax', tags: ['walkable'] }),
    ...
    place('item-claytonpark', 'Clayton Park Bar & Grill', 'restaurant', 44.653, -63.64596, 'Friendly neighbourhood bar & grill, Clayton Park.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-orient', 'The Orient Chinese Cuisine', 'restaurant', 44.647, -63.60046, 'Well-reviewed Chinese restaurant.', { address: 'Halifax', tags: ['kids'] }),
    place('item-cora', 'Cora Breakfast & Lunch', 'restaurant', 44.65, -63.60904, 'Big fruit-topped breakfasts and brunch — very kid-friendly.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-aromalatino', 'Cafe Aroma Latino', 'restaurant', 44.65, -63.58879, 'Mexican-Latin cafe — churros, tapaditos and shakes.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-fiveguys', 'Five Guys', 'restaurant', 44.6485, -63.5738, 'Build-your-own burgers and fresh-cut fries.', { address: 'Halifax', tags: ['kids'] }),
    place('item-cosysnack', 'Cosy Snack Bar', 'restaurant', 44.65, -63.59329, 'Tiny, beloved old-school “greasy spoon” diner.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-graftontheatre', 'Grafton Street Dinner Theatre', 'activity', 44.6478, -63.57254, 'Live musical-comedy show with a three-course meal downtown.', { address: '1741 Grafton St, Halifax', tags: ['walkable'] }),
    ...
    place('item-marthaspizza', "Martha's Pizza II", 'restaurant', 44.644, -63.57504, 'Pizza, donairs, panzerotti and fish & chips, Morris St.', { address: 'Morris St, Halifax', tags: ['kids'] }),
    place('item-layers', 'Layers Cupcakes', 'restaurant', 44.655, -63.58954, 'Fresh-baked cupcakes and treats.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-kebabkitchen', 'Kebab Kitchen', 'restaurant', 44.6485, -63.57254, 'Mediterranean kebabs and mezze in Scotia Square.', { address: 'Scotia Square, Halifax', tags: ['walkable', 'kids'] }),
    place('item-fongsing', 'Fong Sing', 'restaurant', 44.6537, -63.6433, 'Long-running Chinese near Clayton Park.', { address: 'Clayton Park, Halifax', tags: ['kids'] }),
    place('item-busan', 'Busan Korean BBQ', 'restaurant', 44.6481, -63.57635, 'Cook-at-your-table Korean BBQ downtown.', { address: 'Halifax', tags: ['kids'] }),
    place('item-johnnyk', "Johnny K's Authentic Donairs", 'restaurant', 44.646, -63.57496, 'Halifax donairs by Pizza Corner.', { address: 'Blowers St, Halifax', tags: ['walkable', 'kids'] }),
    ...
    place('item-dillpickle', 'The Dill Pickle', 'restaurant', 44.65, -63.59121, 'Salads, sandwiches and quick bites.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-marbleslab', 'Marble Slab Creamery', 'restaurant', 44.64749, -63.57743, 'Custom mix-in ice cream on fresh waffle cones.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-willys', "Willy's", 'restaurant', 44.64914, -63.59379, 'Burgers and killer poutine.', { address: 'Halifax', tags: ['kids'] }),
    place('item-tasteofindia', 'A Taste of India', 'restaurant', 44.6485, -63.57446, 'Indian fast food in the Scotia Square food court.', { address: 'Scotia Square, Halifax', tags: ['walkable', 'kids'] }),
    place('item-songs', "Song's Korean", 'restaurant', 44.6461, -63.59973, 'Korean soups, BBQ and specialties.', { address: 'Halifax', tags: ['kids'] }),
    place('item-lookhoho', 'Look Ho Ho', 'restaurant', 44.648, -63.57696, 'Reasonably-priced classic Chinese, downtown.', { address: 'Halifax', tags: ['kids'] }),
    place('item-rays', "Ray's Lebanese Cuisine", 'restaurant', 44.64914, -63.59, 'Falafel, shawarma and skewers.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-stationsix', 'Station Six', 'restaurant', 44.64612, -63.57501, 'Pub fare — Nashville chicken, burgers, pan-fried haddock.', { address: 'Halifax', tags: ['kids'] }),
    place('item-qiubrothers', 'Qiu Brothers Dumplings', 'restaurant', 44.6459, -63.57635, 'Hand-made dumplings and wonton soup.', { address: 'Halifax', tags: ['kids'] }),
    place('item-kodoraku', 'Ko-Doraku', 'restaurant', 44.64756, -63.59908, 'Japanese sushi, soba and combos.', { address: 'Halifax', tags: ['kids'] }),
    place('item-xenas', "Xena's Bread and Butter", 'restaurant', 44.655, -63.59146, 'Filipino bakery — breakfast, coffee and pastries.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-arisu', 'Arisu Table BBQ and Sushi Bar', 'restaurant', 44.64788, -63.57501, 'All-you-can-eat Korean BBQ and sushi.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-randyspizza', "Randy's Pizza & Donair", 'restaurant', 44.6509, -63.60073, 'Quick pizza, garlic fingers and donairs.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-swisschalet', 'Swiss Chalet', 'restaurant', 44.65, -63.61096, 'Rotisserie chicken and ribs — reliable family chain.', { address: 'Halifax', tags: ['kids'] }),
    place('item-mexis', "Mexi's", 'restaurant', 44.6479, -63.59973, 'Casual Mexican — fajitas and tacos.', { address: 'Halifax', tags: ['kids'] }),
    place('item-cousins', "Cousin's Restaurant", 'restaurant', 44.65086, -63.59379, 'Greek-diner comfort food with big servings.', { address: 'Halifax', tags: ['kids'] }),
    place('item-heartwood', 'Heartwood', 'restaurant', 44.6479, -63.59827, 'Long-running vegetarian/vegan kitchen.', { address: 'Quinpool Rd, Halifax', tags: ['kids'] }),
    place('item-redchillies', 'Redchillies Flavors of India', 'restaurant', 44.65, -63.60146, 'Biryani, tandoori and curries.', { address: 'Halifax', tags: ['kids'] }),
    place('item-fungwah', 'Fung Wah', 'restaurant', 44.65, -63.60004, 'Quick, affordable neighbourhood Chinese.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-budapest', 'Budapest Bisztro', 'restaurant', 44.65086, -63.59, 'Hungarian schnitzel, goulash and langos.', { address: 'Halifax' }),
    place('item-rasa', 'Rasa: Flavours of India', 'restaurant', 44.6461, -63.59759, 'Northern Indian curries and tandoori.', { address: 'Halifax', tags: ['kids'] }),
    place('item-trulytasty', 'Truly Tasty', 'restaurant', 44.64878, -63.595, 'Some of the best ramen in Nova Scotia.', { address: 'Halifax', tags: ['kids'] }),
    place('item-burritojax', 'Burrito Jax', 'restaurant', 44.647, -63.59666, 'Build-your-own burritos and bowls.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-pizzadelic', 'Pizzadelic', 'restaurant', 44.64644, -63.59908, 'Creative pizzas, quick bites.', { address: 'Halifax', tags: ['kids'] }),
    place('item-freshsushi', 'Fresh Happy Healthy Sushi', 'restaurant', 44.65086, -63.59621, 'All-you-can-eat sushi and sushi pizza.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-jennysplace', "Jenny's Place Lounge", 'restaurant', 44.65, -63.59854, 'Friendly, well-priced neighbourhood lounge.', { address: 'Halifax', tags: ['kids'] }),
    place('item-bestchoice', 'Best Choice Chinese Food', 'restaurant', 44.652, -63.60904, 'Big-portion Chinese take-out.', { address: 'Halifax', tags: ['kids'] }),
    place('item-hamachikita', 'Hamachi Kita', 'restaurant', 44.661, -63.60004, 'Sushi in the Hydrostone, North End.', { address: 'Hydrostone, Halifax', tags: ['kids'] }),
    place('item-mezza', 'Mezza Lebanese Kitchen', 'restaurant', 44.64651, -63.57743, 'Fast Lebanese — shawarma, donairs and bowls.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-snappytomato', 'Snappy Tomato Pizza', 'restaurant', 44.6491, -63.60073, 'Quick-bite pizza.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-jeans', "Jean's Restaurant", 'restaurant', 44.65, -63.59671, 'Chinese-Japanese — spicy beef, pad thai, egg rolls.', { address: 'Halifax', tags: ['kids'] }),
    place('item-lacucina', 'La Cucina Cafe Pizzeria', 'restaurant', 44.6509, -63.59927, 'Pizza, pasta and garlic fingers.', { address: 'Halifax', tags: ['kids'] }),
    place('item-pizzadelight', 'Pizza Delight', 'restaurant', 44.652, -63.61096, 'Maritime pizza chain with a lunch buffet.', { address: 'Halifax', tags: ['kids'] }),
    place('item-swaadsagaa', 'Swaad Sagaa Indian Cuisine', 'restaurant', 44.6491, -63.59927, 'Indian fast-casual.', { address: 'Halifax', tags: ['kids'] }),
    place('item-dessertyard', 'Dessert Yard', 'restaurant', 44.65192, -63.5943, 'Milkshakes and over-the-top desserts.', { address: 'Halifax', tags: ['kids'] }),
    place('item-shengs', "Sheng's Chinese Restaurant", 'restaurant', 44.65, -63.60196, 'Egg rolls and lunchtime Chinese.', { address: 'Halifax', tags: ['kids'] }),
    place('item-besharam', 'Besharam Bar and Grill', 'restaurant', 44.648, -63.57504, 'Highly-rated Indian downtown.', { address: 'Halifax', tags: ['walkable', 'kids'] }),
    place('item-kickscafe', 'Kicks Cafe', 'restaurant', 44.64914, -63.59621, 'Casual American-Canadian cafe.', { address: 'Halifax', tags: ['kids'] }),
    ...
    place('item-sailorsalute', "Sailor's Salute Statue", 'landmark', 44.6452, -63.57116, 'The Sailor statue at Sackville Landing on the waterfront.', { address: 'Sackville Landing, Halifax', tags: ['walkable', 'tonight', 'photos'] }),
    ...
    place('item-annaleonowens', 'Anna Leonowens Gallery', 'museum', 44.646, -63.57304, 'NSCAD University gallery with rotating student and faculty shows.', { address: '1891 Granville St, Halifax', tags: ['walkable'] }),
    ...
    place('item-ghostwalk', 'The Halifax Ghost Walk', 'activity', 44.6478, -63.57564, 'Lantern-lit walking tour of ghost, pirate and devil tales through the old streets.', { address: 'Old Town Clock, Halifax', tags: ['walkable'], website: 'https://halifaxghostwalk.com' }),
    place('item-altroutes', 'Alternative Routes Day Tours', 'activity', 44.647, -63.56909, 'Hop-on-hop-off shuttle to Peggy’s Cove, Mahone Bay, Lunenburg and the Valley in a day.', { address: 'Halifax Waterfront', tags: ['daytrip'] }),
    ...
    place('item-ridesolar', 'Ride Solar Pedal-Bus', 'activity', 44.64614, -63.5703, 'Solar-powered 18-seat pedal-bus tours of the city.', { address: 'Halifax Waterfront', tags: ['walkable'] }),
    place('item-rumrunners', 'Rum Runners Rum Cake Factory', 'restaurant', 44.6472, -63.57186, 'Waterfront bakery — famous rum cakes baked on site.', { address: 'Halifax Waterfront', tags: ['walkable', 'tonight', 'kids'] }),
    ...
    place('item-sweetjanes', "Sweet Jane's", 'restaurant', 44.646, -63.57146, 'Vintage candy, retro toys and gourmet treats on Queen St — a kid magnet.', { address: 'Queen St, Halifax', tags: ['walkable', 'kids'] }),
    place('item-amospewter', 'Amos Pewter', 'shopping', 44.64786, -63.5703, 'Waterfront pewter workshop — watch pieces being hand-cast.', { address: 'Halifax Waterfront', tags: ['walkable', 'kids'] }),
    ...
    place('item-halifaxarmoury', 'Halifax Armoury', 'landmark', 44.6512, -63.5882, 'Grand 1899 Victorian drill hall on the edge of the Common.', { address: '2261 North Park St, Halifax', tags: ['walkable'], website: 'https://hmhps.ca/sites/halifax-armouries' }),
    place('item-halifaxcommon', 'Halifax Common', 'outdoor', 44.6500, -63.5912, "Halifax's big central green — ballfields, playground and skate park.", { address: 'North Common, Halifax', tags: ['kids', 'walkable'] }),
    place('item-explosionbelltower', 'Halifax Explosion Memorial Bell Tower', 'landmark', 44.6622, -63.6018, 'Carillon memorial to the 1917 Halifax Explosion, atop Fort Needham hill.', { address: 'Fort Needham Memorial Park, Halifax', tags: ['walkable'] }),
    place('item-halifaxforum', 'Halifax Forum', 'activity', 44.6541, -63.6062, 'Historic arena and event complex — markets, shows and skating.', { address: '2901 Windsor St, Halifax', tags: ['rainy-day'], website: 'https://www.halifaxforum.ca' }),
    place('item-littledutchchurch', 'Little Dutch (Deutsch) Church', 'landmark', 44.6552, -63.5882, "Tiny 1756 church — one of Halifax's oldest buildings (a National Historic Site).", { address: '2393 Brunswick St, Halifax', tags: ['walkable'] }),
    place('item-friendshipcentre', "Mi'kmaw Native Friendship Centre", 'landmark', 44.6539, -63.5921, 'Urban Indigenous community and cultural hub on Gottingen St.', { address: '2158 Gottingen St, Halifax', tags: ['walkable'], website: 'https://www.mymnfc.com' }),
    place('item-stgeorgesround', "Saint George's Round Church", 'landmark', 44.6547, -63.5889, 'Striking circular 1800 Georgian church.', { address: '2222 Brunswick St, Halifax', tags: ['walkable'], website: 'https://www.roundchurch.ca' }),
    place('item-violadesmond', 'The Viola Desmond Experience', 'landmark', 44.6557, -63.5934, 'Public art honouring civil-rights icon Viola Desmond on Gottingen St.', { address: 'Gottingen St, Halifax', tags: ['walkable'] }),
    place('item-14bells', '14 Bells Fine Art Gallery', 'shopping', 44.6648, -63.6055, 'Local fine-art gallery in the Hydrostone Market.', { address: '5523B Young St, Halifax', tags: ['walkable', 'rainy-day'], website: 'https://14bells.com' }),
    place('item-agricolabooks', 'Agricola Street Books', 'shopping', 44.6608, -63.5963, 'Independent neighbourhood book shop on upper Agricola.', { address: '2684 Agricola St, Halifax', tags: ['walkable', 'rainy-day'], website: 'https://www.agricolastreetbooks.com' }),
    place('item-bravadowine', 'Bravado Wine Bar', 'restaurant', 44.6560, -63.5946, 'Wine bar with creative plates and curated pours on Agricola.', { address: '2405 Agricola St, Halifax', tags: ['walkable'], website: 'https://www.bravadowinebar.com' }),
    place('item-frabjouswhim', 'Frabjous Delights & Whim Chocolate', 'shopping', 44.6570, -63.5949, 'Specialty foods and chocolate shop on Agricola.', { address: '2530 Agricola St, Halifax', tags: ['walkable'], website: 'https://www.frabjousdelights.com' }),
    place('item-hopeblooms', 'Hope Blooms', 'outdoor', 44.6519, -63.5882, 'Youth-led, solar-powered urban farm and greenhouse by the Common.', { address: '2346 Brunswick St, Halifax', tags: ['kids'], website: 'https://hopeblooms.ca' }),
    place('item-northisfreedom', 'North is Freedom Monument & North Memorial Library', 'landmark', 44.6555, -63.5912, 'Monument to Black freedom-seekers at the Halifax North Memorial Public Library.', { address: '2285 Gottingen St, Halifax', tags: ['walkable'] }),

    // ---- Downtown Dartmouth (visitor map) ----
    place('item-alderneygatelibrary', 'Alderney Gate Public Library', 'landmark', 44.6663, -63.5675, 'Waterfront public library at Alderney Gate.', { address: '60 Alderney Dr, Dartmouth', tags: ['walkable', 'rainy-day'], website: 'https://www.halifaxpubliclibraries.ca' }),
    place('item-alderneymarina', 'Alderney Marina', 'landmark', 44.6669, -63.5658, 'Dartmouth waterfront marina by Alderney Landing.', { address: 'Alderney Landing, Dartmouth', tags: ['walkable'] }),
    place('item-birchcovebeach', 'Birch Cove Beach', 'beach', 44.6576, -63.5721, 'Supervised freshwater beach on Lake Banook.', { address: 'Birch Cove Park, Dartmouth', tags: ['kids', 'beach'] }),
    place('item-daffodilgarden', 'Daffodil Garden for Cancer Survivors', 'outdoor', 44.6676, -63.5668, 'Seasonal memorial garden at the edge of Ferry Terminal Park.', { address: 'Alderney Dr, Dartmouth', tags: ['walkable'], website: 'https://daffodilgarden.ca' }),
    place('item-easternfront', 'Eastern Front Theatre', 'activity', 44.6664, -63.5664, 'Professional theatre company at Alderney Landing.', { address: '2 Ochterloney St, Dartmouth', tags: ['walkable', 'rainy-day'], website: 'https://www.easternfronttheatre.com' }),
    place('item-ferryterminalpark', 'Ferry Terminal Park', 'outdoor', 44.6670, -63.5669, 'Waterfront green space by the Dartmouth ferry.', { address: '88 Alderney Dr, Dartmouth', tags: ['kids', 'walkable', 'stroller-friendly'] }),
    place('item-leightondillman', 'Leighton Dillman Park', 'outdoor', 44.6640, -63.5696, "Garden park on the Dartmouth Common by Sullivan's Pond.", { address: 'Park Ave, Dartmouth', tags: ['walkable', 'stroller-friendly'] }),
    place('item-pizzaoven', 'Park Avenue Community Pizza Oven', 'activity', 44.6637, -63.5692, 'Volunteer wood-fired community pizza oven in Leighton Dillman Park.', { address: 'Leighton Dillman Park, Dartmouth', tags: ['kids'], website: 'https://www.dartmouth-oven.com' }),
    place('item-worldpeace', 'World Peace Pavilion', 'landmark', 44.6668, -63.5662, 'Waterfront pavilion with stones and artifacts from around the world.', { address: 'Ferry Terminal Park, Dartmouth', tags: ['walkable'] }),
    place('item-craiggallery', 'The Craig Gallery', 'museum', 44.6662, -63.5661, 'Community art gallery inside Alderney Landing.', { address: '2 Ochterloney St, Dartmouth', tags: ['walkable', 'rainy-day'], website: 'https://www.alderneylanding.com' }),
    place('item-dartgallery', 'The Dart Gallery', 'museum', 44.6671, -63.5688, 'Contemporary art gallery on Portland St.', { address: '127 Portland St, Dartmouth', tags: ['walkable', 'rainy-day'], website: 'https://www.thedartgallery.com' }),
    place('item-legionmuseum', 'Royal Canadian Legion Military Museum', 'museum', 44.6652, -63.5679, 'Military-history collection at the Somme Branch Legion.', { address: '52 King St, Dartmouth', tags: ['rainy-day'] }),
    place('item-canalmarinerailway', 'Shubenacadie Canal Marine Railway', 'landmark', 44.6655, -63.5688, 'Restored marine railway from the historic Shubenacadie Canal, in Starr Park.', { address: 'Starr Park, 58 Prince Albert Rd, Dartmouth', tags: ['walkable'], website: 'https://www.shubenacadiecanal.ca' }),
    place('item-keptgifts', 'Kept Gifts & Housewares', 'shopping', 44.6648, -63.5685, 'Gift shop and home goods on King St.', { address: '75 King St, Dartmouth', tags: ['walkable'], website: 'https://keptshop.ca' }),
    place('item-trainyardstore', 'The Trainyard General Store', 'shopping', 44.6674, -63.5682, 'Gift shop and home goods on Portland St.', { address: '137 Portland St, Dartmouth', tags: ['walkable'], website: 'https://trainyardstore.com' }),

    // ---- Downtown Halifax (visitor map) ----
    place('item-casinons', 'Casino Nova Scotia', 'activity', 44.6505, -63.5703, 'Harbourfront casino and entertainment venue.', { address: '1983 Upper Water St, Halifax', tags: ['walkable'], website: 'https://www.casinonovascotia.com' }),
    place('item-dalhousie', 'Dalhousie University', 'landmark', 44.6366, -63.5917, "Nova Scotia's largest university — the leafy Studley campus.", { address: '6299 South St, Halifax', tags: ['walkable'], website: 'https://www.dal.ca' }),
    place('item-kingscollege', "University of King's College", 'landmark', 44.6386, -63.5887, 'Historic small university beside Dalhousie.', { address: '6350 Coburg Rd, Halifax', tags: ['walkable'], website: 'https://ukings.ca' }),
    place('item-conventioncentre', 'Halifax Convention Centre', 'landmark', 44.6464, -63.5748, 'Downtown convention centre in the Nova Centre.', { address: '1650 Argyle St, Halifax', tags: ['walkable', 'rainy-day'], website: 'https://www.halifaxconventioncentre.com' }),
    place('item-nscad', 'NSCAD University', 'landmark', 44.6485, -63.5731, 'Nova Scotia College of Art and Design — historic Granville St campus.', { address: '5163 Duke St, Halifax', tags: ['walkable'], website: 'https://nscad.ca' }),
    place('item-pizzacorner', 'Pizza Corner', 'landmark', 44.6443, -63.5742, 'Late-night pizza-slice corner at Blowers & Grafton.', { address: 'Blowers St & Grafton St, Halifax', tags: ['walkable', 'tonight'] }),
    place('item-rogerssquare', 'Rogers Square', 'landmark', 44.6460, -63.5755, 'Covered open-air plaza in the Nova Centre.', { address: 'Argyle St, Halifax', tags: ['walkable'] }),
    place('item-smu', "Saint Mary's University", 'landmark', 44.6313, -63.5811, 'South-end university campus.', { address: '923 Robie St, Halifax', tags: ['walkable'], website: 'https://www.smu.ca' }),
    place('item-wanderers', 'Wanderers Grounds', 'activity', 44.6418, -63.5805, 'Outdoor stadium — soccer and rugby — beside the Public Gardens.', { address: '5711 Sackville St, Halifax', tags: ['walkable'], website: 'https://hfxwanderers.canpl.ca' }),
    place('item-armymuseum', 'Army Museum', 'museum', 44.6474, -63.5805, 'Military museum inside the Halifax Citadel.', { address: 'Halifax Citadel, Halifax', tags: ['walkable', 'rainy-day'], website: 'https://armymuseumhalifax.ca' }),
    place('item-7virtues', 'The 7 Virtues Perfume Atelier', 'shopping', 44.6470, -63.5707, 'Custom perfume design shop on the waterfront.', { address: '1709 Lower Water St, Halifax', tags: ['walkable'], website: 'https://the7virtues.com' }),
    place('item-art1274', 'Art 1274 Hollis Gallery', 'museum', 44.6398, -63.5715, 'Artist co-op art and fine-craft gallery on Hollis St.', { address: '1274 Hollis St, Halifax', tags: ['walkable', 'rainy-day'], website: 'https://www.art1274hollis.ca' }),
    place('item-fjallraven', 'Fjällräven Halifax', 'shopping', 44.6432, -63.5773, 'Outdoor clothing shop across from the Central Library.', { address: '5415 Spring Garden Rd, Halifax', tags: ['walkable'], website: 'https://www.fjallraven.com' }),
    place('item-fridajewellery', 'Frida Fine Jewellery', 'shopping', 44.6464, -63.5694, "Custom jewellery boutique in Bishop's Landing on the waterfront.", { address: '1477 Lower Water St, Halifax', tags: ['walkable'], website: 'https://frida.ca' }),
    place('item-monkyfunky', 'Monky Funky Cafe', 'restaurant', 44.6454, -63.5737, 'Café and bubble-tea spot on Granville St.', { address: '1594 Granville St, Halifax', tags: ['walkable', 'kids'], website: 'https://monkyfunky.ca' }),
    place('item-northernwatters', 'Northern Watters Knitwear & Tartan Shop', 'shopping', 44.6492, -63.5704, 'Knitwear and tartan artisan shop in Historic Properties.', { address: '1869 Upper Water St, Halifax', tags: ['walkable'], website: 'https://nwknitwear.com' }),
    place('item-parklanemall', 'Park Lane Mall', 'shopping', 44.6428, -63.5790, 'Spring Garden Rd shopping mall with a cinema.', { address: '5657 Spring Garden Rd, Halifax', tags: ['walkable', 'rainy-day', 'stroller-friendly'], website: 'https://shopparklane.ca' }),
    place('item-patagonia', 'Patagonia Halifax', 'shopping', 44.6443, -63.5691, 'Outdoor clothing shop in the Historic Brewery Market.', { address: '1496 Lower Water St, Halifax', tags: ['walkable'], website: 'https://patagoniahalifax.ca' }),
    place('item-prowgallery', 'The Prow Gallery', 'museum', 44.6461, -63.5691, "Fine-art gallery in Bishop's Landing on the waterfront.", { address: '1479 Lower Water St, Halifax', tags: ['walkable', 'rainy-day'], website: 'https://theprowgallery.com' }),
    place('item-seahouse', 'Sea House', 'shopping', 44.6463, -63.5689, "Local retail shop in Bishop's Landing.", { address: '1479 Lower Water St, Halifax', tags: ['walkable'], website: 'https://seahouse.ca' }),
    place('item-springgardenplace', 'Spring Garden Place', 'shopping', 44.6434, -63.5808, 'Boutique shopping mall at Spring Garden & Dresden Row.', { address: '5640 Spring Garden Rd, Halifax', tags: ['walkable', 'rainy-day'], website: 'https://www.springgardenplace.ca' }),
